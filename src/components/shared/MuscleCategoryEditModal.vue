    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-0 relative overflow-y-auto max-h-[90vh]">
      ...
      <div class="grid grid-cols-1 gap-4 px-6 pt-4">
        ...
        <div>
          ...
          <input v-model="local.icon" class="w-full border rounded px-3 py-2" />
        </div>
        <div>
          <label class="block text-sm font-medium mb-1">Sort Order</label>
          <input v-model.number="local.sortOrder" type="number" class="w-full border rounded px-3 py-2" />
        </div>
        <div>
...
const local = ref<Partial<MuscleCategory>>({});
